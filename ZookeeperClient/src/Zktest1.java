...
public class Zktest1 {
    private static final Logger LOG = LoggerFactory.getLogger(Zktest1.class);
    ...
    public void printinof(){
    	System.out.println("is connected:"+zk.getState().isConnected());
    }
    public static void main(String args[])
        throws KeeperException, IOException, InterruptedException
    {
        Zktest1 main = new Zktest1(args);
        main.printinof();
        main.run();
        main.printinof();
    }

    public Zktest1(String args[]) throws IOException, InterruptedException {
